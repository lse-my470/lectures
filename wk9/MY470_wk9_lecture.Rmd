...
- by integer index value, e.g. `x[2]`, `x[5:10]`
...
R has an in-built help facility which provides more information about any (package) function:
...
The quality of the help varies (to put it mildly), but every function is documented.
...
plot(x = my_data$x, y = my_data$y, 
     ...
     main = "Awesome plot title", # main title
     pch = 19,                    # solid points
